...
const Trailer = ({ title, toggleTrailer, large }) => {
  ...
  return (
    <div className="w-full h-full bg-x-mirage/[.85] fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 z-20 flex justify-center items-center p-4 overlay" onClick={exitTrailer}>
